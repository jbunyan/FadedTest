...
(function() {
    ...
    GDHttpRequest.prototype.enableClientCertAuthOnUIWebView = function() {
        console.warn('"enableClientCertAuthOnUIWebView" function is deprecated in GDHttpRequest class. ' +
            'It will be removed in future versions.\n' +
            'Please, use "enableClientCertAuth" function in GDHttpRequest class instead.');
        
        var lAsync = (this.isAsync === false) ? "false" : "true";
        cordovaExec(function() {},
            function() {},
            "GDHttpRequest",
            "enableClientCertAuth", [lAsync, this.requestTag]);
    };
